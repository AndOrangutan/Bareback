...
--              {description = "show main menu", group = "awesome"}),
    ...
    awful.key({}, "XF86MonBrightnessUp", function () awful.util.spawn("blight -d backlight/intel_backlight set +5%") end,
              {description = "Increase brightness by 5%", group = "MediaKeys"}),
    awful.key({}, "XF86MonBrightnessDown", function () awful.util.spawn("blight -d backlight/intel_backlight set -5%") end,
